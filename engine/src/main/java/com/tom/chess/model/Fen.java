...
@Getter
public class Fen {
  //  private static final String STARTING_POSITION = "rnbqkbnr/8p/8/8/8/8/17P/RNBQKBNR w KQkq - 0 1";
  private static final String STARTING_POSITION = "rrrRrrrr/8/8/8/8/8/8/R5RR w KQkq - 0 1";
